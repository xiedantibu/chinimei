...
public class RecipeListAdapter extends BaseAdapter implements MeishiConfig
{
    ...
    private List<RecipeCusineItem> mRecipeCusineItems;

    public RecipeListAdapter(Context mContext,
            List<RecipeCusineItem> mRecipeCusineItems)
    {

        this.mContext = mContext;
        this.mRecipeCusineItems = mRecipeCusineItems;
    ...
    public int getCount()
    {
        return mRecipeCusineItems.size();
    }

    @Override
    public Object getItem(int arg0)
    {
        return mRecipeCusineItems.get(arg0);
    }
    ...
    public View getView(int arg0, View arg1, ViewGroup arg2)
    {
        ...
        if (mRecipeCusineItems != null && mRecipeCusineItems.size() > 0)
        {
            mHolderView.mTextViewName.setText(mRecipeCusineItems.get(arg0)
                    .getRecipetitle().trim());
            ...
            mHolderView.mTextViewContent
                    .setText(String
                            .format(MeishiApplication
                                    ...
                                    mRecipeCusineItems.get(arg0)
                                            .getMainingredient()
                                            .replace("<br />", "")
                                            .replace("&nbsp;", "")));
            mImageLoader.displayImage(MeishiApplication.getApplication().isShowPic()?mRecipeCusineItems.get(arg0).getCover()
                    .trim():null, mHolderView.mImageViewContent, mOptions);
        }
        return arg1;
    }
