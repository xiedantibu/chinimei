...
import com.xlm.meishichina.image.core.download.NetworkDeniedImageDownloader;
...
public final class ImageLoaderConfiguration
{
    ...
    public static class Builder
    {
         ...
         */
        public Builder memoryCacheExtraOptions(int maxImageWidthForMemoryCache,
        ...
        public Builder discCacheExtraOptions(int maxImageWidthForDiscCache,
                int maxImageHeightForDiscCache, CompressFormat compressFormat,
                int compressQuality)
        {
         ...
         * {@link com.xlm.meishichina.image.cache.memory.impl.UsingFreqLimitedMemoryCache
        ...
        public Builder memoryCacheSize(int memoryCacheSize)
        {
            ...
            if (memoryCache != null)
                L.w(WARNING_MEMORY_CACHE_ALREADY_SET);
        ...
        public Builder memoryCache(MemoryCacheAware<String, Bitmap> memoryCache)
        {
            if (memoryCacheSize != DEFAULT_MEMORY_CACHE_SIZE)
                L.w(WARNING_OVERLAP_MEMORY_CACHE_SIZE);
         ...
         * <b>NOTE:</b> If you use this method then
         * {@link com.xlm.meishichina.image.cache.disc.impl.TotalSizeLimitedDiscCache
        ...
        public Builder discCacheSize(int maxCacheSize)
        {
            ...
            if (discCache != null)
                L.w(WARNING_DISC_CACHE_ALREADY_SET);
            if (discCacheFileCount > 0)
                L.w(WARNING_OVERLAP_DISC_CACHE_FILE_COUNT);
         ...
         * By default: disc cache is unlimited.<br />
         * <b>NOTE:</b> If you use this method then
         * {@link com.xlm.meishichina.image.cache.disc.impl.FileCountLimitedDiscCache
        ...
        public Builder discCacheFileCount(int maxFileCount)
        {
            ...
            if (discCache != null)
                L.w(WARNING_DISC_CACHE_ALREADY_SET);
            if (discCacheSize > 0)
                L.w(WARNING_OVERLAP_DISC_CACHE_SIZE);
         ...
         * Default value -
         * {@link com.xlm.meishichina.image.core.DefaultConfigurationFactory#createFileNameGenerator()
         * DefaultConfigurationFactory.createFileNameGenerator()}
         */
        public Builder discCacheFileNameGenerator(
         ...
         * Default value -
         * {@link com.xlm.meishichina.image.core.DefaultConfigurationFactory#createImageDownloader(Context)
         ...
         * Default value -
         * {@link com.xlm.meishichina.image.cache.disc.impl.UnlimitedDiscCache
         * UnlimitedDiscCache}. Cache directory is defined by <b>
         * {@link com.xlm.meishichina.image.utils.StorageUtils#getCacheDirectory(Context)
        ...
        public Builder discCache(DiscCacheAware discCache)
        {
            ...
            if (discCacheFileNameGenerator != null)
                L.w(WARNING_OVERLAP_DISC_CACHE_FILE_NAME_GENERATOR);
        ...
        public Builder enableLogging(boolean flag)
        {
        ...
        private void initEmptyFiledsWithDefaultValues()
        {
            if (discCache == null)
            {
                if (discCacheFileNameGenerator == null)
                {
                    discCacheFileNameGenerator = DefaultConfigurationFactory
                            .createFileNameGenerator();
                }
                discCache = DefaultConfigurationFactory.createDiscCache(
                        context, discCacheFileNameGenerator, discCacheSize,
                        discCacheFileCount);
            }
            if (memoryCache == null)
            {
