 ...
 */
package com.xlm.meishichina.db;
...
import com.xlm.meishichina.db.sqlite.CursorUtils;
import com.xlm.meishichina.db.sqlite.DbModel;
import com.xlm.meishichina.db.sqlite.SqlBuilder;
import com.xlm.meishichina.db.sqlite.SqlInfo;
import com.xlm.meishichina.db.table.ManyToOne;
import com.xlm.meishichina.db.table.OneToMany;
import com.xlm.meishichina.db.table.TableInfo;

public class FinalDb
{

    private static final String TAG = "meishichina";
    ...
    public static class DaoConfig
    {
        ...
        private String dbName = "meishichina.db";// 数据库名字
    ...
    public SQLiteDatabase getSqliteDbHelper()
    {
        return db;
    }
