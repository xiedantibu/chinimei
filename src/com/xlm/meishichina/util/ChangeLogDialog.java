...
public class ChangeLogDialog
{
    ...
    private String GetHTMLChangelog(int aResourceId, Resources aResource)
    {
        ...
        {
            Logmeishi.d(TAG, e.getMessage(), e);
        }
        catch (IOException e)
        {
            Logmeishi.d(TAG, e.getMessage(), e);
    ...
    public void show()
    {
        ...
        try
        {
            _Resource = fActivity.getPackageManager()
                    .getResourcesForApplication(_PackageName);
        }
        ...
        // Get dialog title
        int _resID = _Resource.getIdentifier(TITLE_CHANGELOG, "string",
                _PackageName);
        ...
        if (_HTML.equals("") == true)
        {
            ...
            Toast.makeText(fActivity, "Could not load change log",
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(fActivity)
                .setTitle(_Title).setView(_WebView)
