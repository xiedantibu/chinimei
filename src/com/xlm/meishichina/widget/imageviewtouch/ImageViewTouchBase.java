...
public class ImageViewTouchBase extends ImageView implements IDisposable
{
     ...
     */
    public void setImageBitmap(final Bitmap bitmap, final boolean reset,
            final Matrix matrix, final float maxZoom)
    {
     ...
     * @param matrix
     */
    protected void getProperBaseMatrix(final Drawable drawable,
            final Matrix matrix)
    {
     ...
     * @param matrix
     */
    protected void getProperBaseMatrix2(final Drawable bitmap,
            final Matrix matrix)
    {
        final float viewWidth = getWidth();
        final float viewHeight = getHeight();
    ...
    protected float maxZoom()
    {
        ...
        final float fw = (float) drawable.getIntrinsicWidth()
                / (float) mThisWidth;
        final float fh = (float) drawable.getIntrinsicHeight()
                / (float) mThisHeight;
        final float max;
        if (MeishiApplication.getApplication().getResources()
