...
import com.xlm.meishichina.BuildConfig;
import com.xlm.meishichina.widget.imageviewtouch.ScaleGestureDetector.OnScaleGestureListener;
...
public class ImageViewTouch extends ImageViewTouchBase
{
    ...
    public boolean canScroll(final int direction)
    {
        ...
        final double bitmapScrollRectDelta = Math.abs(bitmapRect.left
                - mScrollRect.left);
    ...
    public void setDoubleTapListener(
            final OnImageViewTouchDoubleTapListener doubleTapListener)
    {
